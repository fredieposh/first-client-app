...
function Login() {
    ...
    const [responseData, setResponseData] = useState< {msg: string}[]| string[] |null>(null);
    ...
    useEffect(() => {
        if (responseData && responseType == 200 && typeof responseData[0] === 'string') {
    ...
    return(
        <div className="flex justify-center mt-8" >
            <form   action={`${API_URL}/login`}
                    onSubmit={(e) => handleSubmit(e, `${API_URL}/login`, { userName, password, setResponseType, setResponseData })}
                    method="POST" 
